...
const seedProjectsData: Omit<Project, "id" | "createdAt" | "updatedAt">[] = [
  { title: "技術・人文知識・国際業務の申請", customerId: "", visaType: "技術・人文知識・国際業務", currentVisaType: "技術・人文知識・国際業務", status: "pending" },
  { title: "経営・管理ビザの申請", customerId: "", visaType: "経営・管理", currentVisaType: "技術・人文知識・国際業務", status: "active" },
  { title: "永住許可の申請", customerId: "", visaType: "永住許可", currentVisaType: "技術・人文知識・国際業務", status: "pending" },
  { title: "留学ビザの申請", customerId: "", visaType: "留学", currentVisaType: "短期滞在", status: "pending" },
  { title: "高度専門職ビザの申請", customerId: "", visaType: "高度専門職", currentVisaType: "技術・人文知識・国際業務", status: "active" },
  { title: "家族滞在ビザの申請", customerId: "", visaType: "家族滞在", currentVisaType: "短期滞在", status: "completed" },
  { title: "技能実習ビザの申請", customerId: "", visaType: "技能実習", currentVisaType: "短期滞在", status: "pending" },
  { title: "定住者ビザの申請", customerId: "", visaType: "定住者", currentVisaType: "家族滞在", status: "active" },
  { title: "技術・人文知識・国際業務の申請", customerId: "", visaType: "技術・人文知識・国際業務", currentVisaType: "留学", status: "pending" },
  { title: "日本人の配偶者等ビザの申請", customerId: "", visaType: "日本人の配偶者等", currentVisaType: "短期滞在", status: "active" },
  { title: "永住者の配偶者等ビザの申請", customerId: "", visaType: "永住者の配偶者等", currentVisaType: "定住者", status: "completed" },
  { title: "特定活動ビザの申請", customerId: "", visaType: "特定活動", currentVisaType: "技術・人文知識・国際業務", status: "pending" },
  { title: "技術・人文知識・国際業務の申請", customerId: "", visaType: "技術・人文知識・国際業務", currentVisaType: "留学", status: "active" },
  { title: "経営・管理ビザの申請", customerId: "", visaType: "経営・管理", currentVisaType: "技術・人文知識・国際業務", status: "completed" },
  { title: "定住者ビザの申請", customerId: "", visaType: "定住者", currentVisaType: "技能実習", status: "completed" },
];
