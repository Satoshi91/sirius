...
import { ProjectDocument, Project, ProjectActivityLog } from "@/types";
...
export default function ProjectTabs({ projectId, documents, project, activityLogs = [] }: ProjectTabsProps) {
